...
def run_verification(playwright):
    ...
    expect(video_player).to_have_attribute("src", re.compile(r"^blob:"), timeout=15000)
    ...
    assert new_time > initial_time, f"Hotkey did not work. Time did not increase from {initial_time}"
